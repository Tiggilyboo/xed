...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = {
    ...
    {KC_F6,   KC_F7,   _______, _______, _______, KC_F9,   KC_F10,  _______,    KC_HOME,    KC_PGDN, KC_PGUP, KC_END }
  },
  [_RAISE] = {
   ...
   */
  [_ADJUST] = {
    {SLEEP,  RESET,   DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_F11 },
