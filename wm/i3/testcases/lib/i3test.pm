...
use X11::XCB::Window;
use X11::XCB qw(:all);
use lib qw(/home/simon/Downloads/i3-4.15/x86_64-pc-linux-gnu/../../i3-4.15/AnyEvent-I3/blib/lib);
use AnyEvent::I3;
...
sub launch_with_config {
    ...
    if ($config ne '-default') {
        ...
        open(my $conf_fh, '<', '/home/simon/Downloads/i3-4.15/x86_64-pc-linux-gnu/../../i3-4.15/testcases/i3-test.config')
